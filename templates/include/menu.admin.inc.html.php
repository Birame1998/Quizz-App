    <div class="taches-admin">
            ...
            <div class="taches">
                ...
                <div class="liste-joueurs">
                    <a href="<?=WEB_ROOT."?controller=user&action=liste.joueurs"?>" id="a_list_joueurs" class="acc-link"><li class="m-link iiiiiiiii" for="img3">Liste Joueurs</li></a>
                    <div class="img3"></div>
                </div>
                <div class="creer-questions">
                <a href="#" class="acc-link"><li class="m-link">Creer une question</li></a>
                    <div class="img4"></div>
                </div>        
            </div>
        </div>    
