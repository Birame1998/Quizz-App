<script src="<?=WEB_ROOT."js".DIRECTORY_SEPARATOR."fonctions.js"?>" type="text/javascript"></script>
<script src="<?=WEB_ROOT."js".DIRECTORY_SEPARATOR."script.validation.js"?>" type="text/javascript"></script>
